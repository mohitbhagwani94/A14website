	...
	<body>
		...
		<div data-role="popup" id="menu" data-theme="d">
			...
			<div data-role="content">
				<h1 style="font-variant:small-caps" align="center"> Mario's Escapade </h1>
				<div data-role="collapsible-set">
					<div data-role="collapsible" data-collapsed="false">
						<h3> Introduction </h3>
						<p align="justify">
							"Peach has been kidnapped by Bowser. Help Mario save Peach in his Kart by overcoming challenges and tackling obstacles while making it to Bowsers 
Castle.
...
"
					...
					<div data-role="collapsible" data-collapsed="true">
						...
						<div align="justify">
							...
							A bridge is just closing midway to the Castle where Peach is being held by Evil Bowser. 
Cross the bridge in Mario’s Kart while going through the circuit before the Bridge closes.


							<h3>Round 2</h3>
							You have made it inside Bowser’s castle Peach is being held at the 5th level. Bowser has set obstacles in 
the path to bring Mario down.<br>
Help Mario pass every obstacle to rescue Princess Peach.
					...
					<div data-role="collapsible" data-collapsed="true">
						...
						<p>
							...
							<b> Aditya Ravi Kumar </b>
							<h5>Mb: 9677118463</h5>

							<b> Harsh Srivastava </b>
							<h5>Mb: 8056677124</h5>
