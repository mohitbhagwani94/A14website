	...
	<body>
		...
		<div data-role="popup" id="menu" data-theme="d">
			...
			<div data-role="content">
				<h1 style="font-variant:small-caps" align="center"> Kryptonics 2.0 </h1>
				<div data-role="collapsible-set">
					<div data-role="collapsible" data-collapsed="false">
						<h3> Introduction </h3>
						<p align="justify">
							The event is an Online Treasure Hunt which consists of different
							levels. Each level has certain clues in the form of pictures and text. You need
							to find out an answer to that to get to the next one. The participant who
							solves all the levels first, wins the event.
					...
					<div data-role="collapsible" data-collapsed="true">
						...
						<div align="justify">
							...
							There will be 30-40 levels in total. With each level, difficulty of
							questions increases.
